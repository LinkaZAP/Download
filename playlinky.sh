...
# A lógica a seguir assume que o ZIP contém uma pasta "PlayLinky"
# Move todos os conteúdos de "PlayLinky" para o diretório atual
if [ -d "PlayLinky" ]; then
    mv PlayLinky/* .
    # Remove a pasta "PlayLinky" agora vazia
    rmdir PlayLinky
fi
